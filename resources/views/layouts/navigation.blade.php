<nav x-data="{ open: false }" class="bg-white dark:bg-brown-800 border-b border-brown-100 dark:border-gray-700">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <x-application-logo class="block h-9 w-auto fill-current text-brown-800 dark:text-gray-200" />
                    </a>
                </div>
